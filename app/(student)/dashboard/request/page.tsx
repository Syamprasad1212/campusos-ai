...
export default function StudentAIRequestPage() {
  ...
  async function handleConfirmSubmit() {
    if (!intakeResult || !intakeResult.workflowKey) return;
    ...
    <div className="max-w-4xl mx-auto space-y-8">
      ...
      <div className="border-b border-slate-200 pb-5 flex items-center justify-between">
        <div>
          ...
          <p className="text-slate-600 text-sm">Describe what you need in plain English. CampusOS matches the workflow and routes it automatically.</p>
        </div>
      ...
      {createdRequest ? (
        <div className="rounded-2xl border border-emerald-200 bg-emerald-50/50 p-8 text-center space-y-6">
          ...
          <div className="mx-auto max-w-md bg-white p-4 rounded-xl border border-emerald-200 text-left text-sm space-y-2 shadow-sm">
            ...
            <div className="flex justify-between">
              ...
              <span>Step 1 (Record Verification)</span>
            </div>
          </div>
          ...
          <div className="flex justify-center gap-4 pt-2">
            <button
              ...
              className="inline-flex items-center gap-2 px-5 py-2.5 rounded-lg bg-sky-600 text-white font-medium text-sm hover:bg-sky-700 transition"
            >
                    ...
                    <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 border-b border-slate-100 pb-4">
                      <div>
                        <span className="text-xs font-bold text-sky-700 uppercase tracking-wider px-2.5 py-1 bg-sky-50 border border-sky-200 rounded-md">
                          Matched Workflow: {intakeResult.workflowKey}
                        </span>
                    ...
                    <div className="border-t border-slate-100 pt-6 flex items-center justify-between">
                      <div className="text-xs text-slate-500">
                        {intakeResult.missingFields.length > 0 ? (
                          ...
                          <span className="text-emerald-700 font-medium">✓ All required information ready</span>
                        )}
                      </div>
